...
public class TelaLog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        filler1 = new javax.swing.Box.Filler(new java.awt.Dimension(400, 400), new java.awt.Dimension(400, 400), new java.awt.Dimension(400, 400));
        ...
        jLabel1.setText("BANCO DE ANGOLA");
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        if(txtUsuario.equals("1") && txtSenha.getText().equals("1")){
            JOptionPane.showMessageDialog(null, "Logado com sucesso");
            new TelaEntrar().setVisible(true );
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(null, "Usuário ou senha errada. Por favor tente novamente.");
        }
